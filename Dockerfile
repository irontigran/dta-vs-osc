...
RUN mkdir -p /home/sip && \
    ...
    python -m pip install 'r2pipe==1.6.5' 'pyelftools==0.27'
...
RUN apt-get install dos2unix && \
    ...
    cd /home/sip/attacking_anti_tamper/tracer && bash ./build.sh Release && \
    cd /home/sip/attacking_anti_tamper/taint_cpp && bash ./build.sh Release && \
    cd /home/sip && mkdir built-sc-virt && cd built-sc-virt && \
    cmake -DCMAKE_CXX_FLAGS="-fuse-ld=lld" ../sc-virt/src && \
    make
